  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-purple-500/10 rounded-full blur-[80px] animate-pulse animation-delay-500" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <div className="relative">
          {/* Outer glow ring */}
          <div className="absolute inset-0 w-28 h-28 rounded-2xl bg-gradient-to-br from-primary to-purple-400 blur-xl opacity-50 animate-pulse" />
          
          {/* Logo container */}
          <div 
            className="relative w-28 h-28 bg-gradient-to-br from-primary to-purple-400 rounded-2xl flex items-center justify-center shadow-2xl"
            style={{
